...
#define NUMERIC_STR_42       "%s :Your Unique EUID"
...
#define NUMERIC_STR_379      "%s :is using modes %s"
#define NUMERIC_STR_381      ":%s 381 %s :You are now an operator."
#define NUMERIC_STR_382      ":%s 382 %s %s :Rehashing"
#define NUMERIC_STR_385      ":%s 385 %s :You are no longer an operator."
...
#define NUMERIC_STR_487      "%s :You must be connected using SSL/TLS to message this user"
...
#define NUMERIC_STR_674      "%s :EUID is %s"
